<?php
$this->params = ['css' => 'css/register.css', 'js' => 'js/register.js'];
?>
<div class="business-register">
		...
		<div class="register-form">
			<form class="form-horizontal panel-body">
	            <div class="form-group ">
	                <label class="col-xs-4" for="register_id">注册序列号：</label>
	                <div class="col-xs-4">
	                    <input type="text" class="form-control" id="register_id" maxlength="8" placeholder="">
	                </div>
	                <div class="col-xs-3">
	                	<p class="high-lighted error-msg hidden"><i class="glyphicon glyphicon-remove-sign"></i> <span>注册码错误！</span></p>
	                </div>
	            </div>
	            <div class="form-group ">
	                <label class="col-xs-4" for="user_name">姓名：</label>
	                <div class="col-xs-4">
	            ...
	            <div class="form-group">
	                <label class="col-xs-4" for="password">密码：</label>
	                <div class="col-xs-4">
	            ...
	            <div class="form-group">
	                <label class="col-xs-4" for="confrim">确认密码：</label>
	                <div class="col-xs-4">
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-xs-4">
	                    <a class="btn col-xs-12 business-btn" id="J_register_btn">注册</a>
	                </div>
	            </div>
	        </form>
		</div>
	...
	<footer class="footer">
	    ...
	    <h5>电话：400-0318-119&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;邮箱：service@9daye.com.cn</h5>
	</footer>
</div>
