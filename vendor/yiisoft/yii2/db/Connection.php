...
class Connection extends Component
{
    ...
    /**
     * @var boolean 是否强制从主数据库查询
     * 阿里云RDS读写分离Hint配置；设置为true，之后的所有读操作均从主数据库执行
     */
    private $_queryMaster = false;

    public function getQueryMaster(){
        return $this->_queryMaster;
    }

    public function setQueryMaster(bool $switch, bool $reset = true){
        $this->_queryMaster = $switch;
        Yii::$app->RQ->setGlobalQuery($switch, $reset);
        return true;
    }
