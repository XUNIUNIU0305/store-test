...
use Yii;
use common\ActiveRecord\AdminCancelCustomUserLogAR;
use common\ActiveRecord\AdminUserAR;
use common\components\handler\VisitorHandler;
use yii\base\Object;

class AdminCancelCustomUserLog extends Object
{
    ...
    private function generate($return = 'throw')
    {
        try {
            $log = new AdminCancelCustomUserLogAR();
            $log->custom_user_id = $this->_custom_user_id;
            $log->operate_type = SELF::OPERATE_TYPE_DELETE;
