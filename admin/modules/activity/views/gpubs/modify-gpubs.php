<?php
$this->params = ['js' => 'js/modify-gpubs.js', 'css' => 'css/modify-gpubs.css'];
?>
    ...
    <div class="add-group-pro-container">
        ...
        <div class="pro-info-container">
            ...
            <div class="input-group set-box">
                ...
                <div class="set-container">
                    <div class="common-set">
                        <!--
                        <div class="input-group">
                            <input type="number" placeholder="" name="" id="total-price" disabled>
                            元
                        </div>
                        -->
                        <div class="input-group">
                            ...
                            <table class="table table-bordered text-center">
                                ...
                                {@each i in range(0,row)}
                                    <tr>
                                        ...
                                        <td>
                                            <div class="stock">
                                                <input type="number" class='J_count'>
                                                <span>件</span>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <div class="handle-box">
                <span class="btn btn-danger" id="modify-btn">修改</span>
            </div>
        </div>
    </div>
</div>
