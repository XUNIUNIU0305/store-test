        ...
        getUerRanking: function () {
            requestUrl('/temp/rank/user-rank', 'GET', '', function (data) {
                if (data.rank !== 0) {
                    ...
                    $('#my_rank').html(data.rank);
                    $('#my_account').html(data.account);
                    $('#my_shopname').html(data.shopname);
                    $('#my_mobile').html(data.mobile);
                    $('#my_price').html('￥' + parseFloat(data.consumption).toFixed(2));
                }
            })
        },
        init: function () {
